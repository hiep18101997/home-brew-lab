  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AnalyticsBloc, AnalyticsState>(
      builder: (context, state) {
        ...
        final analytics = (state as AnalyticsSuccess).analytics;
...
class _MethodPieChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (data.isEmpty) return Center(child: Text('No data', style: GoogleFonts.manrope(color: AppColors.onSurfaceVariant)));
    final colors = [AppColors.secondary, AppColors.primary, AppColors.tertiary, AppColors.secondary.withValues(alpha: 0.7), AppColors.primary.withValues(alpha: 0.7), AppColors.tertiary.withValues(alpha: 0.7)];
      ...
      LineChartData(
        ...
        lineBarsData: [
          LineChartBarData(
            ...
            belowBarData: BarAreaData(show: true, color: AppColors.tertiary.withValues(alpha: 0.2)),
          ),
        ],
        titlesData: FlTitlesData(
